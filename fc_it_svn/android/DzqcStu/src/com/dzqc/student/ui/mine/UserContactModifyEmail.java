...
public class UserContactModifyEmail extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.personal_contact_modify_email);
	...
	private void initHeader() {
		...
		tvHeader.setText(getResources().getString(R.string.mine_modify_email));
	}

	private void initView() {
		tvSubmit = (TextView) findViewById(R.id.tv_emailSubmit);
		etNewEmail = (EditText) findViewById(R.id.et_newEmail);
	...
	public void onClick(View v) {
		...
		case R.id.img_registerBack:
			AppManager.getAppManager().finishActivity(UserContactModifyEmail.this);
			break;
		case R.id.tv_emailSubmit://提交修改
			break;
		default:
			break;
		}
