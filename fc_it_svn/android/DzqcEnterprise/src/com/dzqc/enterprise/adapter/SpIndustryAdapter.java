...
public class SpIndustryAdapter extends BaseAdapter {
	Context c;
	ArrayList<Object> arrayList;
	Holider holider;

	public SpIndustryAdapter(Context c, ArrayList<Object> arrayList) {
		this.c = c;
	...
	public View getView(int index, View view, ViewGroup parent) {
		...
		holider.txtName.setText((String)arrayList.get(index));
		return view;
	}
