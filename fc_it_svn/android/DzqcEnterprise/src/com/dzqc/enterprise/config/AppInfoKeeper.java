...
public class AppInfoKeeper {
	...
	public static SharedPreferences initShaerPreferences() {
		if (appSharedPreferences == null)
			appSharedPreferences = DzqcEnterprise.getInstance().getSharedPreferences(AppInfoKeeper.class.getName(), AppInfoKeeper.getMode());
	...
	// 获取已选择学校IDs
		public static String getSelectSchool() {
			return initShaerPreferences().getString("schoolIds", "000000");
		}

		// 设置学校IDs
		public static void setSelectSchool(String id) {
			Editor editor = initShaerPreferences().edit();
			editor.putString("schoolIds", id);
			editor.commit();
		}
