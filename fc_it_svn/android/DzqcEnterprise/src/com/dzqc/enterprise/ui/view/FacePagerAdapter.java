...
import com.dzqc.enterprise.utils.EmojiMapUtil;
...
public class FacePagerAdapter extends PagerAdapter {
	...
	// 表情符号大小
	private final static int faceSize = DensityUtils.dp2Px(DzqcEnterprise.getInstance(), 20);
	// 每一行的高度
	public final static int rowHeight = DensityUtils.dp2Px(DzqcEnterprise.getInstance(), 44);
