...
public final class CameraManager {
	...
	private static int MIN_FRAME_WIDTH = DensityUtils.dp2Px(
			DzqcEnterprise.getInstance(), 200);
	private static int MIN_FRAME_HEIGHT = DensityUtils.dp2Px(
			DzqcEnterprise.getInstance(), 200);
	private static int MAX_FRAME_WIDTH = DensityUtils.dp2Px(
			DzqcEnterprise.getInstance(), 200);
	private static int MAX_FRAME_HEIGHT = DensityUtils.dp2Px(
			DzqcEnterprise.getInstance(), 200);
	...
	public static void init(Context context) {
		...
		MIN_FRAME_WIDTH = (3 * w) / 5;
		MIN_FRAME_HEIGHT = (3 * w) / 5;
		MAX_FRAME_WIDTH = (3 * w) / 5;
		MAX_FRAME_HEIGHT = (3 * w) / 5;
	}
