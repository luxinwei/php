...
class QPage {
	...
	public function __construct($totalRows, $listRows = '', $parameter = '', $url = '') {
		...
		$this->varPage = C ( 'VAR_PAGE' ) ? C ( 'VAR_PAGE' ) : 'nowPage';
		if (! empty ( $listRows )) {
			$this->listRows = intval ( $listRows );
		} else {
			$this->varOnePage = C ( 'VAR_ONE_PAGE' ) ? C ( 'VAR_ONE_PAGE' ) : 'onePage';
			
			!I ( $this->varOnePage )||$this->listRows =I ( $this->varOnePage );
			
			
		}
		$this->totalPages = ceil ( $this->totalRows / $this->listRows ); //总页数                                                                                                                                                
		$this->coolPages = ceil ( $this->totalPages / $this->rollPage );
		$get_nowPage=I ( $this->varPage ) ;
		if (! empty ($get_nowPage)) {
			$this->nowPage =$get_nowPage;
		}
