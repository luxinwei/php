...
class Method {
	...
	static function curl_post($url, $arg = NULL, $getCookie = 0, $sendCookie = 0, $header = null, $ingore = false) {
		...
		//		curl_setopt ( $ch, CURLOPT_HTTPHEADER, $headerArr ); //构造IP
				curl_setopt ( $ch, CURLOPT_REFERER, "http://app.lhq8.com/user/login" ); //构造来路
		...
		curl_setopt ( $ch, CURLOPT_USERAGENT, 'Dalvik/1.6.0 (Linux; U; Android 4.2.2; GT-P5210 Build/JDQ39E)' );
