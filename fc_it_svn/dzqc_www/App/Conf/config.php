...
'UC_API_MIYAO'=>'dzqc20160519api',
'M_API_MIYAO'=>'dzqc2016yui',
'UC_API_HOST'=>"http://192.168.1.189/dzqc_ucenter/",
...
'SESSION_AUTO_START' => true,
   ...
   'URL_MODEL'             => 1, 
'EMAIL_SENDER'=>array(
	'serverAdds'=>"smtp.exmail.qq.com",
	'serverPort'=>"25",
	'creater'=>"guowei.dai@dzqcedu.com",
	'password'=>"Dai123",
	'replayAddr'=>"guowei.dai@dzqcedu.com",
	'sendername'=>"打造前程",
),
'DZQC_WWW_HOST'=>'http://192.168.1.189/dzqc_www/',
'UPLOAD_PATH'=>ROOT."/upload",
'QINIU_IMG_DOMAIN'=>'http://7xuiva.com1.z0.glb.clouddn.com/',
)
;
