...
{//另外一个控制器的view
    ...
    CGRect rect = CGRectMake((SCREEN_WIDTH-90)/2, (SCREEN_HEIGHT-64-90)/2, 90, 90);
   ...
   // [self setCenter:CGPointMake(SCREEN_WIDTH/2, SCREEN_HEIGHT/2)];
    ...
    if (self) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 45, 90, 30)];
...
- (id)initWithView:(UIView*)view text:(NSString*)text duration:(float)inDuration
{
    ...
    CGSize size=[text boundingRectWithSize:CGSizeMake(SCREEN_WIDTH-20, 50000000) options:NSStringDrawingTruncatesLastVisibleLine |NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:arrtribute context:nil].size;
