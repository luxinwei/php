  ...
  $.post(url,params,function(responseText){
	     ...
	     var result=responseText;
	      ...
	      for(var i=0;i<resultobj.data.length;i++){
	    	  ...
	    	  treecontent+="\n{\"id\":\""+resultobj.data[i]["id"]+"\", \"pId\":\""+pId+"\", \"name\":\""+resultobj.data[i]["name"]+"\", \"levell\":\""+resultobj.data[i]["level"]+"\", \"appCode\":\""+resultobj.data[i]["appCode"]+"\", \"menuId\":\""+resultobj.data[i]["menuId"]+"\", \"sortNum\":\""+resultobj.data[i]["sortNum"]+"\", \"menuIds\":\""+resultobj.data[i]["menuIds"]+"\"}";
	      }
...
//============================
		...
		function beforeEditName(treeId, treeNode) {
			...
			setTimeout(function() {
				...
				//	zTree.editName(treeNode);
					...
					var appCode=treeNode.appCode;
					var name=treeNode.name;
					var levell=treeNode.levell;
 	 				var url="menumanagement_update.php?id="+ids+"&pId="+pId+"&appCode="+appCode+"&detailid="+id
		...
		function addHoverDom(treeId, treeNode) {
			...
			if (btn) btn.bind("click", function(){
				...
				var pId=treeNode.pId;
				var appCode=treeNode.appCode;
 				 var url="menumanagement_add.php?id="+ids+"&pId="+pId+"&appCode="+appCode+"&detailid="+id;
				$("#menumanagement_iframe").attr("src",url);
				return false;
			});
		};
