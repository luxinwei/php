...
<caption>平面图</caption>
    <tr>
	    ...
	    <td>
		    ...
		    <input type="text" id="file_base64">
...
<script type="text/javascript" src="js/commandcentre_update.js"></script>