...
foreach ($list as $obj){
	...
	$objx=array();
	$objx["name"]=$obj->name;
	$objx["areaName"]=$obj->areaName;
	$objx["liaisonOfficer"]=$obj->liaisonOfficer;
	$objx["liaisonOfficerPhone"]=$obj->liaisonOfficerPhone;
	$objx["scopeCoordinates"]=$obj->scopeCoordinates;
	$objx["parentDepName"]=$obj->parentDepName;
	$dataResult[]=$objx;
			}
		}
}
