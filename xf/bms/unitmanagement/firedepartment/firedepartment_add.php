...
<div align="center" style="background-color: #FFFFFF;min-height:700px" class="mt10 p20 hmui-shadow">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="hmui-form" width="1200">
    ...
    <tr>
      ...
      <td><input class="hmui-input w" id="telephone" maxlength="15"/></td>
       <th><font class="cred">*</font>部门负责人姓名</th>
      <td><input class="hmui-input w"id="liaisonOfficer" maxlength="20" /></td>
    </tr>
    <tr>
      <th><font class="cred">*</font>部门负责人人电话</th>
      <td><input class="hmui-input w" id="liaisonOfficerPhone" maxlength="15" /></td>
        <th><font class="cred">*</font>部门级别</th>
      <td>
         <select class="hmui-select w"  id="fireServiceCode">
    <option value="">请选择部门级别</option>
    <?php echo DicationaryUtil::getInstance()->getSelectOptionCodeStr("fireServiceCode", "")?>
    </select>
    </td>
    </tr>
    <tr>
...
<script type="text/javascript" src="js/firedepartment_add.js"></script>