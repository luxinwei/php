...
<table width="1200" class="hmui-form">
 <tr>
    <th width="15%"><font class="cred">*</font>厂商名称</th>
     <td width="35%"><input class="hmui-input w" id="manuid" manuidValue="" /></td>
    
    <th  width="15%"><font class="cred">*</font>型号名称</td>
    <td width="35%"><input  class="hmui-input w " id="model"/></td>     
  </tr>
...
<script type="text/javascript" src="js/modelmanagement_build.js"></script>