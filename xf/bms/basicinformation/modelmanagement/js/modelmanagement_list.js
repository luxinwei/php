...
/*				content+="<tr align='center'>";
			    ...
			    content+="<tr align='center'>";
				content+="<td align='center'>";                                                  
				content+="<input type=\"checkbox\" class=\"hmui-checkbox\" name=\"key\"   />";           
				content+="</td>";
 				content+="<td>"+"SN97"+"</td>";
...
$("#btn_add").bind("click", function(){ 
	var tourl="modelmanagement_build.php";  
...
$("#btn_edit").bind("click", function(){
	...
	var key=row.value;
	window.location.href="modelmanagement_update.php?id="+key;	 	 
});
//删除动作---删除单条数据=========================================
$("#btn_del").bind("click", function(){
	  ...
	  //  if(row.row<=0){alert("请选择要删除的信息");return false;}
		...
		var url=rootPath+"/com/base/InterfaceDeleteAction.php";
		 ...
		 if(row.row>1){
		    	alert(row.value);
		    	 params={uri:"part_models/batch",commitData:row.value};
