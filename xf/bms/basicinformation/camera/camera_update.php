...
<table width="1200" class="hmui-form">
  	<tr>
    <th width="15%"><font class="cred">*</font>品牌</th>
	...
	<tr>
  		<th  width="160px;"><font class="cred">*</font>型号</th>
   		<td><input  class="hmui-input w" id="position"  /></td>
   		<th  width="160px;"><font class="cred">*</font>验证码</th>
   		<td><input  class="hmui-input w" id="position"  /></td>
  	</tr>
  		<tr>
  		<th  width="160px;"><font class="cred">*</font>序列号</th>
...
<script type="text/javascript" src="js/camera_update.js"></script>