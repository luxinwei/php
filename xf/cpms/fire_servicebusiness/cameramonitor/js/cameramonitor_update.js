singlePicUpload();
//返回列表==========================================
$("#btn_history").bind("click", function(){window.location.href="cameramonitor_detail.php?id="+id;});
	...
	$.post(url,params,function(responseText){	
		// 调试//$("#detail").parent().after(responseText);
		 var resultobj=eval("("+responseText+")");
		     ...
		     var content="";   
		     if(success){
		    	 $("#cameraname").val(resultobj["data"]["name"]);
		    	 ...
		    	 $("#impPartId").attr("impPartIdValue",resultobj["data"]["impPartId"]);
		    	 $("#deviceId").val(resultobj["data"]["deviceName"]); 
		    	 $("#deviceId").attr("deviceIdValue",resultobj["data"]["deviceId"]);
		    	 $("#code").val(resultobj["data"]["code"]);
		    	 $("#floor").val(resultobj["data"]["floor"]);
		    	 $("#authCode").val(resultobj["data"]["authCode"]);
		    	 $("#ip").val(resultobj["data"]["ip"]);
		    	 $("#port").val(resultobj["data"]["port"]);
	...
	$.post(url,params,function(responseText){	
		//$("#detail").parent().after(responseText);
		 var resultobj=eval("("+responseText+")");
		     ...
		     if(success){
		    	 alert("成功");
		    	window.location.href="cameramonitor_detail.php?id="+id;
		    }else{
		    	var message=resultobj.message; 
		    	alert("错误码："+code+message);
		    }   
