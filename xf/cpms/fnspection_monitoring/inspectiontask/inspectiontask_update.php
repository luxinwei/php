...
<table border="0" cellpadding="0" cellspacing="0" class="hmui-form mt5" width="1200">
  ...
  <tr>
    <th width="15%">巡查任务名称</th>
    <td width="35%">
	 <input  class="hmui-input w" id="insname"/>
	 <input type="hidden"  class="hmui-input" id="executeDepId"/>
	 <input type="hidden"  class="hmui-input" id="depId"/>
    </td>
    <th width="15%">巡查人员</th>
    <td width="35%"><input  class="hmui-input w hand" id="patrolUser" patrolUserValue=""/></td>
  </tr>
  <tr>
    ...
    <td colspan="3">
  			<?php for ($i=1;$i<25;$i++){?>
  					<span style="display: inline-block;width: 60px;line-height: 30px">
 			  		<input class=" s" type="checkbox" name="strategy" value="<?php echo $i?>"/><?php echo $i?>点 
 			  		</span>
   				 <?php }?>          
