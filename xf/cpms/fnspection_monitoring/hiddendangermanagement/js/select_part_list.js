...
function selectFun(id,title){
	...
	$("#patrolPointId",window.parent.document).attr("patrolPointIdValue",id)
	$("#patrolPointId",window.parent.document).val(title);


	window.parent.SelectDataHideDiv("patrolPointId");
