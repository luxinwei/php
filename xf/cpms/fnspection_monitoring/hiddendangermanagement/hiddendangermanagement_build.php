...
<table width="1200" class="hmui-form">
  <tr> 
    <th width="15%">部门名称</th>
    <td width="35%"><input class="hmui-input w" id="depId" value="1" depIdValue=""/></td>
    <th width="15%">巡查点名称</th>
    <td width="35%"><input class="hmui-input w hand" id="patrolPointId" patrolPointIdValue=""/></td>
  </tr>
    <tr>
    <th>发现时间</th>
...
<script type="text/javascript" src="js/hiddendangermanagement_build.js"></script>