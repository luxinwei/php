...
<script type="text/javascript" src="../../../etc/js/echarts/echarts-all.js"></script>
            ...
            <div class="layui-tab-content " style="width:100%;background:#FFFFFF;" id="c_content">
                 ...
                 <div class="layui-tab-item layui-show " ><iframe id="li" frameborder=0  class="iframe_content" style="width:100%;min-height:700px;" src="electricmonitor_list9.php?partId=<?php echo $partId?>"></iframe></div>
              </div>
            </div>
