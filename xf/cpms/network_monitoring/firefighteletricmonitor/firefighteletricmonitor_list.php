...
<div class="hmui-tabu hmui-shadow mt10">
    <!-- 树形图 -->
        ...
        <div class="fr" style="width:calc(100% - 290px);background:#FFFFFF;padding:15px 30px 15px 20px;" id="main_con">
          <iframe id="firefighteletricmonitor_main_iframe" name="firefighteletricmonitor_main_iframe" frameborder=0   style="width:100%;min-height:500px;" src="firefighteletricmonitor_main.php" ></iframe>
        </div>
        <div class="cb"></div>
</div>
...
$("#firefighteletricmonitor_main_iframe").height(bodyheight-70);
</script>           
<script type="text/javascript" src="js/firefighteletricmonitor_list.js"></script>