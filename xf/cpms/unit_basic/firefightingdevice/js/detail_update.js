 	 ...
 	 $("#systemForm").find("option[value='"+resultobj["data"]["systemForm"]+"']").attr("selected",true);
		...
		//4。判断id所属形式添加内容
	 	 var content="";
			...
			//---------------------------------------------------------------------------------------------------------------------------
			 if(systemFormId=="8"){//火灾自动报警
					for(var i=0;i<deviceTypeCode_jsarray.length;i++){
						if(deviceTypeCode_jsarray[i][0]==1||deviceTypeCode_jsarray[i][0]==2||deviceTypeCode_jsarray[i][0]==3||deviceTypeCode_jsarray[i][0]==4)
...
//---------------------------------------------------------------------------------------------------------------------------
		...
		//b.准备要追加的内容
					...
					content+="<td><input class=\"hmui-input w\" id=\"count1\"/></td>"; 
					content+="</tr>"  ; 
				   	content+="<tr name=\"ms\">";
					content+="<th><font class=\"cred\">*</font>手动报警按钮流量</th>";
					content+="<td><input class=\"hmui-input w\" id=\"count2\"/></td>";
					content+="<th><font class=\"cred\">*</font>消防电气控制装置扬程</th>";
					content+="<td><input class=\"hmui-input w\" id=\"count3\"/></td>"; 
					content+="</tr>"  ; 
		//c.清空之前追加的内容
