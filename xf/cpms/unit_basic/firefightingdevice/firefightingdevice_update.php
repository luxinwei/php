...
<table width="1200" class="hmui-form">
	    <tr>
		    <th width="15%"><font class="cred">*</font>设施名称</th>
		    <td width="35%"><input class="hmui-input w" id="fightingname"/></td>
		    
		    <th  width="15%"><font class="cred">*</font>所属建筑物</th>
...
<script type="text/javascript" src="js/firefightingdevice_update.js"></script>
<script type="text/javascript" src="js/update.js"></script>
<script type="text/javascript" src="js/detail_update.js"></script>
