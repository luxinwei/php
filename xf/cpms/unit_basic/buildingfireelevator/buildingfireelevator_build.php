...
<table width="1200" class="hmui-form">
    ...
    <td><input class="hmui-input w" id="areaName"/></td>  
</tr> 
<tr>
   ...
   <tr>
    ...
    <td><input class="hmui-input w" id="copeCoordinates"/></td>  
...
<script type="text/javascript" src="js/buildingfireelevator_build.js"></script>