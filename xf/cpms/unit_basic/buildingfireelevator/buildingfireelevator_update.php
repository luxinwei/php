...
<table width="1200" class="hmui-form">
		...
		<tr>
			<th ><font class="cred">*</font>消防电梯位置</th>
			<td ><input class="hmui-input w" id="position" name="position"/></td>
			<th ><font class="cred">*</font>消防电梯容纳重量</th>
			<td><input class="hmui-input w" id="holdWeight" name="holdWeight" placeholder="（kg）"/><span></span></td>
		</tr>
...
<script type="text/javascript" src="js/buildingfireelevator_update.js"></script>