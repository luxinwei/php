...
function search(){
	...
	if(params!="")params+="&";
	params+="uri=building_fire_elevators";
  	 ...
  	 for(j=0;j<data.length;j++){ 
  		...
  		content+="<tr align=\'center\'>"; 
   		...
   		content+="</td>";                                                                                                                                                       
			...
			content+="<td>"+data[j]["holdWeight"]+"</td>";                        
			content+="<td class=\"tc\">";   
			content+="<a class=\"hmui-btn-primary\" href=\"buildingfireelevator_detail.php?id="+id+"\"></a>";
			content+="</td>";
			content+="</tr>"; 
...
$("#btn_add").bind("click", function(){ 
	var tourl="buildingfireelevator_build.php";  
...
$("#btn_edit").bind("click", function(){
	...
	var key=row.value;
	window.location.href="buildingfireelevator_update.php?id="+key;	 	 
});
//删除动作---删除单条数据=========================================
...
$("#btn_xls").bind("click", function(){
		...
		var ids=row.value;
		var tourl="buildingfireelevator_xls.php?ids="+ids;
		window.open(tourl);
});