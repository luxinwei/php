...
//修改信息==========================================
$("#btn_edit").bind("click", function(){window.location.href="adjacentbuilding_update.php?id="+id;});
...
function initDetail(){
	...
	$.post(url,params,function(responseText){	
		////$("#detail").parent().after(responseText);
	     ...
	     var content="";   
	     if(success){
	    	 $("#buildingDrectionCode").html(resultobj["data"]["buildingDrectionCode"]);
	    	 $("#bname").html(resultobj["data"]["name"]);
