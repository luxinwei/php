...
foreach ($list as $obj){
	...
	$objx["buildingDrectionCode"]=$obj->buildingDrectionCode;
	$objx["name"]=$obj->name;
	$objx["buildingUseKindCode"]=$obj->buildingUseKindCode;
	$objx["buildingStructureCode"]=$obj->buildingStructureCode;
	$objx["height"]=$obj->height;
	$objx["standoffDistance"]=$obj->standoffDistance;
	$dataResult[]=$objx;
			}
		}
}
