...
function selectFun(id,title){
	...
	$("#importantPartId",window.parent.document).attr("importantPartIdvalue",id)
	$("#importantPartId",window.parent.document).val(title);


	window.parent.SelectDataHideDiv("importantPartId");
