...
function selectFun(id,title){
	...
	$("#buildingId",window.parent.document).attr("buildIdValue",id)
	$("#buildingId",window.parent.document).val(title);


	window.parent.SelectDataHideDiv("buildingId");
