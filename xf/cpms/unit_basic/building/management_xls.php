...
foreach ($list as $obj){
	for($index=0;$index<$num;$index++){
  			if($obj->id==$idsarray[$index]){
 				$objx=array();
				$objx["name"]=$obj->name;
				$objx["buildingTypeCode"]=$obj->buildingTypeCode;
				$objx["buildingUseKindCode"]=$obj->buildingUseKindCode;
				$objx["buildingFireDangerCode"]=$obj->buildingFireDangerCode;
				$objx["buildingResistFireCode"]=$obj->buildingResistFireCode;
				$objx["buildHeight"]=$obj->buildHeight;
				$objx["workerNum"]=$obj->workerNum;
				$objx["controlRoomPosition"]=$obj->controlRoomPosition;
				$dataResult[]=$objx;
			}
		}
}
