...
function selectFun(id,title){
	...
	$("#affiliatedCenter",window.parent.document).attr("affiliatedCenterValue",id)
	$("#affiliatedCenter",window.parent.document).val(title);


	window.parent.SelectDataHideDiv("affiliatedCenter");
