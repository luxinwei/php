...
include dirname(__FILE__)."/../../../com/core/fim/FimGroup.class.php";
include dirname(__FILE__)."/../../../com/core/fim/FimOrg.class.php";
include dirname(__FILE__)."/../../../com/base/util/FimGroupUtil.class.php";
