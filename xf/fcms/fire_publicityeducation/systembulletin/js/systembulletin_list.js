$("#btn_build").bind("click", function(){window.location.href="systembulletin_build.php?m="+m;});
$("#btn_prc").bind("click", function(){
	var tourl="systembulletin_pic.php?m="+m;
	var iWidth=1000; 
	var iHeight=800; 
...
function processData(resultobj){
	...
	if(success){
		...
		for(j=0;j<data.length;j++){
			...
			content+="<td class=\"tc\">";
			content+="<a class=\"hmui-btn-primary\" href=\"firekonwledge_detail.php?id="+id+"\"></a>";
			content+="</td>";
			content+="</tr>";
