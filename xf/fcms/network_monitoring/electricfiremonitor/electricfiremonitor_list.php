...
<div class="hmui-tabu hmui-shadow mt10">
    <!-- 树形图 -->
        ...
        <div class="fr" style="width:calc(100% - 340px);background:#FFFFFF;padding:15px 30px 15px 20px;" id="main_con">
          <iframe id="electricfiremonitor_main_iframe" name="electricfiremonitor_main_iframe" frameborder=0   style="width:100%;min-height:500px;" src="electricfiremonitor_main.php" ></iframe>
        </div>
        <div class="cb"></div>
</div>
