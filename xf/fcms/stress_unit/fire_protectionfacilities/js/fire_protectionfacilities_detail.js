...
//返回列表==========================================
$("#btn_history").bind("click", function(){window.location.href="fire_protectionfacilities_list.php";});
...
//	  $("#tbody_content").parent().after(responseText);
	     ...
	     if(success){
	    	 ...
	    	 $("#serviceTime").html(timeFormat(resultobj["data"]["serviceTime"]));
	    	 ...
	    	 $("#maintenanceTel").html(resultobj["data"]["maintenanceTel"]);
 	    	 $("#runStateCode").html(fnChangeName(resultobj["data"]["runStateCode"],runStateCode_jsarry));
  	    	 $("#stateChangeTime").html(timeFormat(resultobj["data"]["stateChangeTime"]));
