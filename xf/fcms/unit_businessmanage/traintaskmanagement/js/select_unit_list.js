...
function selectFun(id,title){
	...
	$("#executeDepId",window.parent.document).attr("executeDepIdValue",id)
	$("#executeDepId",window.parent.document).val(title);


	window.parent.SelectDataHideDiv("executeDepId");
