...
$libsArray=array("0"=> "1小时","1"=> "2小时");
$timeArray=array("0"=> "1小时","1"=> "2小时");
?>
...
<table border="0" cellpadding="0" cellspacing="0" class="hmui-form mt5" width="1200">
  <tr>
    <th width="15%">选择公司</th>
    <td width="35%"><input  class="hmui-input w hand" id="executeDepId"  executeDepIdValue="" /></td>
  ...
  <tr>
    ...
    <th>巡查点</th>
     ...
     <td ><input class="hmui-input w hand" id="btn_chose" readonly="readonly"/> </td>
    ...
    <td colspan="3">
  			<?php for ($i=1;$i<25;$i++){?>
  					<span style="display: inline-block;width: 60px;line-height: 30px">
 			  		<input class="hmui-checkbox w" type="checkbox" name="strategy" value="<?php echo $i?>"/><?php echo $i?>点 
 			  		</span>
   				 <?php }?>          
...
<script type="text/javascript" src="js/inspectiontask_build.js"></script>