...
K.options = {
	...
	items : [
		...
		'flash', 'flv', 'media', 'insertfile', 'table', 'hr', 'emoticons', 'baidumap', 'pagebreak',
	...
	*/
	...
	htmlTags : {
		...
		embed: ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess', "allowfullscreen"],
